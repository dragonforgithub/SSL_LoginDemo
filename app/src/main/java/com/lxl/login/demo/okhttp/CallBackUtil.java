package com.lxl.login.demo.okhttp;
    ...
    public static abstract class CallBackFile extends CallBackUtil<File>{
        ...
        public File onParseResponse(Call call, Response response) {
            ...
            try{
                ...
                Log.i("SSL","Download file total size = " + total);
                ...
                Log.i("SSL","save path = " + file.getAbsolutePath());

                fos = new FileOutputStream(file);
                while ((len = is.read(buf)) != -1){
                    sum += len;
                    fos.write(buf, 0, len);
                    Log.i("SSL","write length = " + len + "save length = " + sum);
